...
> **覆盖 2200 万活跃开发者 · 定位准确率 74.1% · 首次实现无自填依赖的全域地理推断**

“开源经纬”是一个**可交互式的开源世界人口普查平台**，基于 OpenDigger 全域 GitHub 日志数据（涵盖 2024–2025 年超 5000 万开发者的完整行为流），通过融合姓名文化、协作时区、邮箱域名与社交网络等多维信号，**预测并估算出全球约 2200 万活跃开发者的地理位置**。我们不仅发布了迄今最细粒度的开发者地理分布数据集，更构建了可公开访问的**交互式 3D 地球与热力地图**，让每一份代码贡献都有其真实坐标。
...
我们构建了首个基于行为推断的**全球开源开发者三维地理分布系统**，以真实地球为载体，将 2200 万+ 开发者按国家/地区标注在地表，并用柱状高度表示其数量规模。

<img width="5120" height="2638" alt="image" src="https://github.com/user-attachments/assets/f92fd67f-9994-494e-befe-3fc3b17053a5" />

> 🔍 **核心功能**：
> - 拖动旋转地球，从任意角度观察全球开发者分布；
> - 悬停查看每个国家的开发者数量与所属大洲；
> - 实时显示 Top 10 国家排行榜。

> 🚀 **点击上图**，进入 [在线交互式地球仪表盘](https://tiai-thisisai.github.io/OpenRank2025/)，亲身体验开源世界的“数字星图”。

> 💡 本系统由 “开源经纬” 模型驱动，所有地理位置均来自无自填依赖的多源信号融合推断，确保数据真实可信。
